...
## 4. Image Carousel (Trình trượt ảnh)

Dùng để hiển thị một nhóm ảnh trong một không gian gọn gàng, có thể trượt qua lại.
...
```
- **Tính năng:**
  - Tự động gom tất cả ảnh nằm bên trong block `[!CAROUSEL]`.
  - Hỗ trợ nút điều hướng và chấm chỉ vị trí.
  - Tích hợp Lightbox (nhấn vào ảnh để phóng to).

---

## 5. Hình ảnh & GIF Premium
