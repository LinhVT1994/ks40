      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        {book.cover && (
          <>
            ...
            />
            <div className="absolute inset-0 bg-slate-50/40 dark:bg-slate-950/60" />
      ...
      <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10 px-6 lg:px-12">
        ...
        <div className="lg:col-span-5 flex justify-center lg:justify-start">
           <div className="relative group [perspective:2000px]">
              ...
              <div className="absolute inset-0 w-64 md:w-85 aspect-[3/4.2] bg-slate-100 dark:bg-slate-700 rounded-r-lg shadow-lg translate-x-1 translate-y-0.5 rotate-y-12 opacity-80" />
              
              {/* Actual Book Cover */}
              <div className="relative w-64 md:w-85 aspect-[3/4.2] rounded-r-2xl overflow-hidden shadow-[30px_50px_100px_-20px_rgba(0,0,0,0.3)] dark:shadow-[30px_50px_100px_-20px_rgba(0,0,0,0.5)] border-l-[12px] border-slate-900/10 dark:border-white/5 transform [transform-style:preserve-3d] rotate-y-15 group-hover:rotate-y-5 transition-all duration-1000 ease-out">
                {book.cover ? (
              ...
              <div className="absolute -bottom-8 -right-8 p-5 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/20 dark:border-white/10 transform hover:scale-110 transition-transform">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-0.5">Chapters</div>
                       <div className="text-xl font-black text-slate-900 dark:text-white leading-none">{book._count.chapters}</div>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="lg:col-span-7 text-center lg:text-left space-y-10">
           <div className="space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white font-display leading-[1] tracking-tight">
                {book.title}
              </h1>
           ...
           {/* Meta Info Bar */}
           <div className="flex flex-wrap items-center justify-center lg:justify-start gap-10 py-8 border-y border-slate-200/60 dark:border-white/5">
              <div className="flex items-center gap-4">
                 <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white dark:border-white/10 shadow-lg ring-4 ring-primary/5">
                    {book.author.image ? <img src={book.author.image} alt="" className="w-full h-full object-cover" /> : <div className="w-full h-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center font-bold text-slate-400">?</div>}
                 </div>
                 <div>
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Tác giả</div>
                    <div className="text-base font-black text-slate-900 dark:text-white tracking-tight">{book.author.name}</div>
                 </div>
              </div>
              
              <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/5 border border-slate-200/60 dark:border-white/10 shadow-sm flex items-center justify-center text-slate-400">
                     <Clock className="w-6 h-6" />
                  </div>
                  <div>
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Cập nhật</div>
                    <div className="text-base font-black text-slate-900 dark:text-white tracking-tight">{new Intl.DateTimeFormat('vi-VN').format(book.createdAt)}</div>
                  </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Member</div>
                    <div className="text-base font-black text-slate-900 dark:text-white tracking-tight">2.5k+</div>
                  </div>
              </div>
           </div>
           ...
           <div className="flex flex-wrap items-center justify-center lg:justify-start gap-5">
              <button className="flex items-center gap-4 px-10 py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-[2rem] text-lg font-black hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-slate-900/20 dark:shadow-white/5 group">
                 <Play className="w-6 h-6 fill-current group-hover:text-primary transition-colors" /> Bắt đầu ngay
              </button>
              
              <div className="flex items-center gap-3">
                 <button className="p-5 rounded-[1.5rem] bg-white dark:bg-white/5 border border-slate-200/60 dark:border-white/10 text-slate-500 hover:text-primary hover:border-primary/30 transition-all shadow-sm group" title="Lưu vào bookshelf">
                    <Bookmark className="w-6 h-6 group-hover:fill-current" />
                 </button>
                 <button className="p-5 rounded-[1.5rem] bg-white dark:bg-white/5 border border-slate-200/60 dark:border-white/10 text-slate-500 hover:text-primary hover:border-primary/30 transition-all shadow-sm group" title="Chia sẻ">
