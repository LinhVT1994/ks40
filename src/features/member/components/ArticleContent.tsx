...
export default function ArticleContent({
  ...
  const innerContent = (
    <div data-article-content>
      {overview && (
        <div className="w-full max-w-[720px] xl:max-w-[600px] 2xl:max-w-[720px] mx-auto mb-2 md:mb-4 relative z-10">
          <div className="relative overflow-hidden px-0 py-2 mb-2 group">
      ...
      {objectives && (
        <div className="w-full max-w-[720px] xl:max-w-[600px] 2xl:max-w-[720px] mx-auto mb-4">
