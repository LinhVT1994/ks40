...
export default function TestimonialsCarousel() {
  ...
  return (
    <section className="px-5 md:px-12 py-20 md:py-32 bg-slate-50 dark:bg-slate-950/20 relative overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto relative z-10">
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 dark:text-white font-display mb-6 md:mb-8 tracking-tight">Member nói gì?</h2>
        ...
        >
          {TESTIMONIALS.map((t) => (
            <div key={t.id} className="w-[85vw] md:w-full shrink-0 snap-center p-8 md:p-10 bg-white dark:bg-white/[0.02] border border-slate-200/60 dark:border-white/5 rounded-[2.5rem] md:rounded-[3.5rem] shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-500 group relative">
              <div className="flex items-center gap-4 md:gap-5 mb-8 md:mb-10">
                ...
                <div>
                  <h5 className="text-lg md:text-xl font-black text-slate-900 dark:text-white tracking-tight">{t.name}</h5>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.role}</p>
                </div>
              </div>

              <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 leading-relaxed font-medium italic">
            ...
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 ${
                activeSlide === i
                  ...
                  : 'w-1.5 bg-slate-300 dark:bg-white/10 hover:bg-slate-400'
              }`}
