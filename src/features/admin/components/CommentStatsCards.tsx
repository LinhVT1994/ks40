...
export default function CommentStatsCards({ counts }: Props) {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
      {[
        { label: 'Tổng bình luận', value: counts.all,     color: 'text-slate-900 dark:text-white'  },
        ...
        <div key={s.label} className="bg-white dark:bg-white/[0.02] border border-slate-100 dark:border-white/5 rounded-2xl px-5 py-4">
