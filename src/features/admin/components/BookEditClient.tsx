        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 dark:border-white/5 pb-6">
          <div className="flex items-center gap-4">
            <Link
              ...
              className="p-2.5 bg-slate-100 dark:bg-white/5 text-slate-500 hover:text-slate-900 dark:hover:text-white rounded-2xl transition-colors"
            >
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white font-display">Chỉnh sửa Lộ trình</h2>
              <p className="text-slate-500 mt-1">Cập nhật thông tin cơ bản của cuốn sách.</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Link
              href={`/admin/books/${book.id}/chapters`}
              className="flex items-center gap-2 px-5 py-2.5 bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-300 rounded-xl text-sm font-bold hover:bg-slate-200 dark:hover:bg-white/10 transition-all"
            >
              Quản lý Chapters
            </Link>
            <button
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full max-w-[500px] text-base bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900 dark:text-white"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full max-w-[500px] text-sm font-mono bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900 dark:text-white"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full text-sm bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none text-slate-900 dark:text-white"
              />
            </div>
