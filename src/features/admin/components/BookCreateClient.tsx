      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-zinc-200 dark:border-white/5 pb-6">
          <div className="flex items-center gap-4">
            <Link href="/admin/documents?tab=books" className="p-2.5 bg-zinc-100 dark:bg-white/5 text-zinc-500 hover:text-zinc-800 dark:hover:text-white rounded-2xl transition-colors">
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div>
              <h2 className="text-2xl font-bold text-zinc-800 dark:text-white font-display">Thông tin Lộ trình</h2>
              <p className="text-zinc-500 mt-1">Thiết lập cấu trúc lõi cho cuốn sách hoặc khóa học mới.</p>
            </div>
          </div>
          <button 
