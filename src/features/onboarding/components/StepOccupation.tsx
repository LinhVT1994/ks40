  ...
  return (
    <div className="space-y-10">
      <div className="space-y-1">
        ...
        <h1 className="text-xl font-bold text-slate-900 dark:text-white">Bạn đang làm gì? 👋</h1>
        <p className="text-slate-500 dark:text-slate-400 text-sm">Chọn vai trò phù hợp nhất với bạn.</p>
      </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full border-2 text-sm font-semibold transition-all duration-200 ${
                isActive
                  ...
                  : 'border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 text-slate-700 dark:text-slate-300 hover:border-primary/50 hover:bg-primary/5'
              }`}
            >
              <span>{emoji}</span>
              {label}
