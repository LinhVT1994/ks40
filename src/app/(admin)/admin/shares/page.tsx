  ...
  return (
    <>
      ...
      <div className="flex-1 p-6 md:p-8 space-y-6 overflow-y-auto">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white font-display">Chia sẻ file</h1>
          <p className="text-sm text-slate-500 mt-1">Tạo gói tài liệu với nhiều file và chia sẻ bằng một link.</p>
        </div>
