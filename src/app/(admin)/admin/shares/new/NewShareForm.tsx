        ...
        <div className="space-y-10">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full max-w-lg text-base bg-zinc-50 dark:bg-white/5 border border-zinc-300 dark:border-white/10 rounded-xl px-4 py-3.5 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-zinc-800 dark:text-white placeholder:text-zinc-500"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full max-w-lg text-sm bg-zinc-50 dark:bg-white/5 border border-zinc-300 dark:border-white/10 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-zinc-800 dark:text-white placeholder:text-zinc-500 font-mono"
            />
